...
/**
 * Neko (AI agent) workspace surface (RFC-003, P1.3): the settings controls + the preview sandbox.
 * Mirrors the Help Center page shell (top bar with a back-link, tabbed body); the app/app layout
 * gates auth.
 */
    ...
    <div className="flex h-screen flex-col bg-background">
      ...
      <div className="flex items-center gap-1 border-b border-border px-4 py-2">
        {(["settings", "preview"] as const).map((t) => (
          ...
          >
            {t === "preview" ? "Preview sandbox" : "Settings"}
          </button>
        ))}
      </div>
